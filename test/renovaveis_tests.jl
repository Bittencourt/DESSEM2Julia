...
@testset "Renovaveis Parser Tests" begin
    ...
    @testset "Full File Parsing - Synthetic" begin
        ...
        try
            open(temp_file, "w") do io
                ...
                println(
                    io,
                    "EOLICA ;    2 ;5G262  _MMGD_F_262_00262_MGD             ;      9999 ;1.0 ;0;",
                )
                println(
                    io,
                    "EOLICA ;    3 ;5G263  _MMGD_F_263_00263_MGD             ;      9999 ;1.0 ;0;",
                )
                println(
                    io,
                    "EOLICA ;   43 ;GTCUFG _CJGUAIMBE_00409_UFV              ;      9999 ;1.0 ;1;",
                )
                println(
                    io,
                    "EOLICA ;  199 ;3RUECI _CIDREIRA_01347_UEE               ;      9999 ;1.0 ;0;",
                )
                ...
                println(
                    io,
                    "EOLICA ; 1000 ;TEST_PLANT_12345_PCH                    ;       250 ;0.8 ;1;",
                )
            end
    ...
    @testset "Comment and Blank Line Handling" begin
        ...
        try
            open(temp_file, "w") do io
                ...
                println(
                    io,
                    "EOLICA ;    1 ;Plant1                                  ;      100  ;1.0 ;0;",
                )
                println(io, "")
                println(io, "& Comment between records")
                println(
                    io,
                    "EOLICA ;    2 ;Plant2                                  ;      200  ;0.5 ;1;",
                )
                println(io, "")
            end
    ...
    @testset "Real CCEE Sample Data" begin
        ...
        if isfile(filepath)
            @testset "CCEE File Parsing" begin
                ...
                @test all(
                    s -> s.subsystem in ["N", "NE", "S", "SE"],
                    data.subsystem_mappings,
                )
                ...
                for s in data.subsystem_mappings
                    subsystem_counts[s.subsystem] =
                        get(subsystem_counts, s.subsystem, 0) + 1
                end
    ...
    @testset "Error Handling" begin
        ...
        @test_throws Exception parse_renovaveis_record(
            "EOLICA ;    1 ;PlantName",
            "test.dat",
            1,
        )
