...
using DESSEM2Julia.TermdatParser:
    parse_cadusit,
    parse_cadunidt,
    parse_curvacomb,
    parse_cadconf,
...
@testset "TERMDAT Parser Tests" begin
    ...
    @testset "CADCONF - Combined Cycle Configuration" begin
        ...
        @test_throws ParserError parse_cadconf("CADCONF 9999   1   1", "test.dat", 2)
    end
    ...
    @testset "CADMIN - Simple Cycle Configuration" begin
        ...
        @test_throws ParserError parse_cadmin("CADMIN   58   0   1", "test.dat", 2)
    end
