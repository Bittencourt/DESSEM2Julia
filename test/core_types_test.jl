...
case = DessemCase(case_name = "TEST_CASE", case_title = "Test Case")
...
# Test ThermalPlant
thermal = ThermalPlant(plant_num = 101, plant_name = "ANGRA1", subsystem = 1, num_units = 1)

println("✓ ThermalPlant created successfully")
println("  Plant: $(thermal.plant_name)")

# Test TimePeriod
period = TimePeriod(period_id = 1, day = 1, hour = 0, network_flag = 0)
