...
#
# When creating error handling tests, verify test patterns align with idessem/inewave.
# Check how these reference implementations test error paths.
# Use sintetizador-dessem patterns for generating test data if needed.
