...
export RenovaveisRecord, RenovaveisSubsystemRecord, RenovaveisBusRecord, RenovaveisGenerationRecord, RenovaveisData, parse_renovaveis, parse_renovaveis_record
...
include("types.jl"); using .Types: DessemData, ThermalRegistry, CADUSIT, CADUNIDT, CURVACOMB, GeneralData, TMRecord, SISTRecord, UHRecord, UTRecord, DPRecord, OperuhData, HydroConstraintREST, HydroConstraintELEM, HydroConstraintLIM, HydroConstraintVAR, OperutData, INITRecord, OPERRecord, DadvazData, DadvazHeader, DadvazInflowRecord, DeflantData, DeflantRecord, DesseletData, DesseletBaseCase, DesseletPatamar, HidrData, CADUSIH, USITVIAG, POLCOT, POLARE, POLJUS, COEFEVA, CADCONJ, BinaryHidrRecord, BinaryHidrData, SimulData, SimulHeader, DiscRecord, VoliRecord, OperRecord, DessOpcData, AreaRecord, UsinaRecord, AreaContData, CotaR11Record, CotasR11Data, CurvTviagRecord, CurvTviagData, RenovaveisRecord, RenovaveisSubsystemRecord, RenovaveisBusRecord, RenovaveisGenerationRecord, RenovaveisData, RespotRP, RespotLM, RespotData, NetworkBus, NetworkLine, NetworkTopology
...
include("parser/simul.jl"); using .SimulParser: parse_simul
include("parser/dessopc.jl"); using .DessOpcParser: parse_dessopc
...
include("parser/renovaveis.jl"); using .RenovaveisParser: parse_renovaveis, parse_renovaveis_record, parse_renovaveis_subsystem_record, parse_renovaveis_bus_record, parse_renovaveis_generation_record
include("parser/respot.jl"); using .RespotParser: parse_respot, parse_rp_record, parse_lm_record
